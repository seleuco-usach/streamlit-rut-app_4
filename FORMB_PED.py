...
MU_SIES[MU_SIES['mc_codigo_unico'].isin(["I71S1C43J1V1", 
                                         "I71S1C145J1V1", 
                                         "I71S1C145J1V2",
                                         "I71S1C395J1V1",
                                         "I71S1C395J1V2"])].groupby([
                                                        'mm_n_documento', 
                                                        'mm_sexo',
                                                        'periodo_matricula',
                                                        'COMP_LECT', 
...
MU_SIES[MU_SIES['mc_codigo_unico'].isin([
    "I71S1C43J1V1", "I71S1C145J1V1", "I71S1C145J1V2", "I71S1C395J1V1", "I71S1C395J1V2"
])]
...
MU_SIES.groupby([
    ...
    'MATEMATICA', 
    'mc_codigo_unico'
])['mm_n_documento'].nunique().reset_index(name='rut_unicos')
...
pd.read_sql("""SELECT
            ...
            LEFT JOIN CPP_DR c
            ON CONCAT(v.ano_proceso, '-', v.cod_usach)=c.ANHO_PLAN""", con_1).to_clipboard()
...
MU_SIES[MU_SIES['mc_codigo_unico'].isin(["I71S1C43J1V1", 
                                         ...
                                         "I71S1C145J1V2",
                                         "I71S1C395J1V1",
                                         "I71S1C395J1V2"])].groupby(['mc_codigo_unico', 
                                                                     'periodo_matricula'])[['COMP_LECT', 
                                                                                            'MATEMATICA']].mean().mean(axis=1).to_clipboard()
